...
const gal = new (0, _simplelightboxDefault.default)(".gallery a", {
    captions: true,
    captionDelay: 250
});
const queryObj = {
...
function scroll() {
    if (queryObj.page !== 1) {
        let { height: cardHeight  } = document.querySelector(".gallery").firstElementChild.getBoundingClientRect();
        window.scrollBy({
            top: cardHeight * 2,
            behavior: "smooth"
        });
...
async function getPictures(url) {
    try {
        ...
        if (queryObj.page === 1) (0, _notiflixNotifyAio.Notify).info(`Hooray! We found ${response.data.totalHits} images.`);
...
},{"notiflix/build/notiflix-notify-aio":"eXQLZ","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eXQLZ":[function(require,module,exports) {
var global = arguments[3];
/*
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequired7c6")
